<%@ Page Title="" Language="C#" MasterPageFile="~/Yoneticim/Yonetici.Master" AutoEventWireup="true" CodeBehind="SehirGuncelle.aspx.cs" Inherits="GezginimBlog.Yoneticim.SehirGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="KategoriContainer">
        ...
        <div class="KategoriContent">
            ...
            <div class="row">
                <asp:LinkButton ID="lbtn_ekleme" runat="server" OnClick="lbtn_ekleme_Click" CssClass="EkleButton">Şehir Güncelle</asp:LinkButton>
            </div>
        </div>
    </div>
</asp:Content>
